 ...
 *
 * Provides the orchestrating app with generated file paths, per-format errors,
 * and timing information without coupling it to exceptions.
 */
final readonly class ReportResult
{
    /**
     * @param  array<string, string>      $files      Format → absolute path, e.g. ['xlsx' => '/tmp/report.xlsx']
